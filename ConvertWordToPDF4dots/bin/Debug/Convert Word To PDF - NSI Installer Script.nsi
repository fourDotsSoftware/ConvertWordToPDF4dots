...
;copy translations end
  ...
  !define MUI_FILE "ConvertWordToPDF4dots"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Convert Word to PDF 4dots"
  !define PRODUCT_SHORTCUT "Convert Word to PDF 4dots"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Convert Word to PDF 4dots"
  OutFile "ConvertWordToPDF4dotsSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Convert Word to PDF 4dots" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Convert Word to PDF 4dots - User's Manual.url.lnk" "$INSTDIR\Convert Word to PDF 4dots - User's Manual.url" "" "$INSTDIR\Convert Word to PDF 4dots - User's Manual.url" 0
...
;  ExecWait "$PLUGINSDIR\Installmanager.exe 015" 
 ...
 ; File "readme.txt"
  ;File "..\..\..\helpfile\Convert Word to PDF 4dots - User's Manual.chm";
  File "Convert Word to PDF 4dots - User's Manual.url";
  File "ddb.dat"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Convert Word to PDF 4dots" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Convert Word to PDF 4dots" "InstallationDirectory" $INSTDIR
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Convert Word to PDF 4dots"
  DeleteRegKey HKCU "Software\4dots Software\Convert Word to PDF 4dots"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/convert-word-to-pdf/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/convert-word-to-pdf/how-to-use.php?afterinstall=true"
FunctionEnd
