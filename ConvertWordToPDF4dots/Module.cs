...
namespace ConvertWordToPDF4dots
{
    class Module
    {
        ...
        public static string ApplicationName = "Convert Word To PDF 4dots";
        ...
        public static string DownloadURL = "https://www.4dots-software.com/d/ConvertWordToPDF4dots/";
        public static string HelpURL = "https://www.4dots-software.com/convert-word-to-pdf/how-to-use.php";
        public static string ProductWebpageURL = "https://www.4dots-software.com/convert-word-to-pdf/";
        public static string BuyURL = "https://www.4dots-software.com/store/buy-convert-word-to-pdf.php";
        public static string VersionURL = "http://cssspritestool.com/versions/convert-word-to-pdf.txt";

        public static string TipText = TranslateHelper.Translate("Great application to Convert Word to PDF !");        
        ...
        public static string OpenFilesFilter =
            ...
            //"Word Files (*.ppt;*.pot;*.pps;*.pptx;*.pptm;*.potx;*.potm;*.ppsx;*.ppsm)|*.ppt;*.pot;*.pps;*.pptx;*.pptm;*.potx;*.potm;*.ppsx;*.ppsm|"
